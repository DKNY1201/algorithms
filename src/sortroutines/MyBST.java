...
//		}
		...
		int[] unsortedArr = {4,53,2,3,6,8,0,7,66,44,5,63};
		
		int[] sorted = bst.sort(unsortedArr);
		for (int i: sorted) {
			System.out.print(i + " ");
		}
...
//		bst2.printTree();
	...
	private void sort(Node t) {
		if (t != null) {
			sort(t.left);
			sortedArr[pos++] = t.element;
			sort(t.right);
		}
	}
}